...
<div class="not-find-container">
    <div class="not-find-container-center">
        <?php
        get_template_part('/templates/header/header', 'ad');
        get_template_part('/templates/header/header', 'navigation');
        ?>
        <div class="not-find-container-center-svg">
            <svg data-name="mainImage" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 171.2 81.5">
                <style id="svgStyle">
                ...
                <path class="cls-3"
                      d="M55.37,38.47a140,140,0,0,1,30.44-3c26,0,47,5.71,47,12.76,0,2.4-2.44,4.65-6.69,6.57"></path>
                ...
                <rect id="c-2" class="changeColor cls-7" x="74.82" y="26.48" width="19.14" height="2.45"
                      transform="translate(1.29 -3.65) rotate(2.49)" style="fill: rgb(99, 0, 237);"></rect>
                ...
                <path class="cls-5"
                      d="M57.7,62.49H93.25A3.67,3.67,0,0,0,92.92,61H53.43A6.69,6.69,0,0,0,57.7,62.49Z"></path>
                ...
                <text id="title" transform="matrix(1 0 0 1 44.7249 78)">Sorry！未找到相关内容</text>
            </svg>
        </div>
    </div>
    <div class="not-find-container-right">
        <?php
        get_sidebar()
        ?>
    </div>
